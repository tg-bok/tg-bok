    ...
    def main_menu() -> dict:
        return {
            ...
            "reply_markup": [
                ...
                [{"text": "🏷️ 用户分类", "callback_data": "adm:classify"}, {"text": "🧩 项目管理", "callback_data": "adm:projects"}],
                ...
                [{"text": "⚙️ 系统设置", "callback_data": "adm:settings"}, {"text": "🔄 刷新菜单", "callback_data": "adm:main"}],
            ],
        }
...
class TGAdminCallbackRouter:
    ...
    def handle(self, admin_chat_id: int, callback_data: str, operator: str = "admin") -> None:
        ...
        if action == "dashboard":
            ...
            return
        submenu_map = {
            "users": ([ [{"text":"📋 用户列表","callback_data":"adm:users:list"},{"text":"⭐ 高意向用户","callback_data":"adm:queue:high_intent"}], [{"text":"🕒 最近活跃","callback_data":"adm:users:recent"},{"text":"↩️ 返回主菜单","callback_data":"adm:main"}] ], "👥 用户管理"),
            "classify": ([ [{"text":"🏷️ 查看分类结果","callback_data":"adm:classify:view"},{"text":"🔒 锁定管理","callback_data":"adm:classify:locks"}], [{"text":"↩️ 返回主菜单","callback_data":"adm:main"}] ], "🏷️ 用户分类"),
            "projects": ([ [{"text":"📚 项目列表","callback_data":"adm:projects:list"},{"text":"➕ 添加项目","callback_data":"adm:projects:add"}], [{"text":"↩️ 返回主菜单","callback_data":"adm:main"}] ], "🧩 项目管理"),
            "materials": ([ [{"text":"🧩 项目素材","callback_data":"adm:materials:project"},{"text":"🌤️ 日常素材","callback_data":"adm:materials:daily"}], [{"text":"↩️ 返回主菜单","callback_data":"adm:main"}] ], "🗂️ 素材管理"),
            "persona_materials": ([ [{"text":"🪪 查看人设素材","callback_data":"adm:persona:list"},{"text":"➕ 添加人设素材","callback_data":"adm:persona:add"}], [{"text":"↩️ 返回主菜单","callback_data":"adm:main"}] ], "🪪 人设素材"),
            "scripts": ([ [{"text":"📝 查看脚本","callback_data":"adm:scripts:list"},{"text":"➕ 添加脚本","callback_data":"adm:scripts:add"}], [{"text":"↩️ 返回主菜单","callback_data":"adm:main"}] ], "📝 脚本管理"),
            "handover": ([ [{"text":"🤝 接管中列表","callback_data":"adm:queue:urgent_handover"},{"text":"⏳ 待恢复AI","callback_data":"adm:queue:pending_resume"}], [{"text":"↩️ 返回主菜单","callback_data":"adm:main"}] ], "🤝 接管管理"),
            "queues": ([ [{"text":"📂 全部队列","callback_data":"adm:queue:all"},{"text":"🔥 高意向客户","callback_data":"adm:queue:high_intent"}], [{"text":"↩️ 返回主菜单","callback_data":"adm:main"}] ], "📚 队列中心"),
            "receipts": ([ [{"text":"🧾 待审核回执","callback_data":"adm:receipts:pending"}], [{"text":"↩️ 返回主菜单","callback_data":"adm:main"}] ], "🧾 回执审核"),
            "settings": ([ [{"text":"⚙️ 系统状态","callback_data":"adm:settings:status"}], [{"text":"↩️ 返回主菜单","callback_data":"adm:main"}] ], "⚙️ 系统设置"),
        }
        if action in submenu_map:
            markup, title = submenu_map[action]
            self.tg_sender.send_admin_message(admin_chat_id, title, markup)
            return
